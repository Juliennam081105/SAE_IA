...
#include "conv2d_9.h" // InputLayer is excluded
#include "flatten_3.h" // InputLayer is excluded
#include "dense_6.h" // InputLayer is excluded
#include "dense_7.h"
#endif
...
typedef dense_7_output_type output_t;
